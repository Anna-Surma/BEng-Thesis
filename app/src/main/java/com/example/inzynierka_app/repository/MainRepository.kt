...
class MainRepository @Inject constructor(
    ...
    suspend fun readArray(request: ArrayList<ReadDataRequest>) = apiHelper.readArray(request)

    suspend fun writeArray(request: ArrayList<WriteDataRequest>) = apiHelper.writeArray(request)
